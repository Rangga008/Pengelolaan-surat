        ...
        <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
            <div class="container">
                <div class="row justify-content-center">
                    <div
                        class="col-xl-5 col-xxl-4 col-lg-5 col-md-7 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h5 class="card-title text-center pb-0 fs-6">Aplikasi Pengarsipan Surat,
                                                Inventaris, dan Mutasi Barang</h5>
                                            <p class="text-center">SDN 024 Coblong</p>
                                        </div>
                                    </div>
                                ...
                                <form class="row g-3 needs-validation mt-1" novalidate method="POST">
                                    ...
                                    <div class="col-12">
                                        <label for="username_user" class="form-label">Email</label>
                                        <input type="email" autofocus name="username_user" class="form-control"
                                            id="username_user" required>
