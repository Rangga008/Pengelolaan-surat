        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label for="username_user" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="username_user" name="username_user" required
                                value="<?= $row['username_user']; ?>">
                            <div class="invalid-feedback">
                                Harap isi Email.
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="status_user" required>
                                <option <?= $row['status_user'] == 'ADMIN' ? 'selected' : ''; ?> value="ADMIN">Admin
                                </option>
                                <option <?= $row['status_user'] == 'PETUGAS' ? 'selected' : ''; ?> value="PETUGAS">
                                    Petugas</option>
                                <option <?= $row['status_user'] == 'PIMPINAN' ? 'selected' : ''; ?> value="PIMPINAN">
                                    Pimpinan</option>
                            </select>
                            <div class="invalid-feedback">
